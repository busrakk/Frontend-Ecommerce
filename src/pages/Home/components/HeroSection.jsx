...
const HeroSection = () => {
  ...
  return (
    ...
    //   <div class="container mx-auto px-20 flex relative pt-16">
    ...
    //       </div>
    //       <div class="flex mt-8">
    //       <NavLink to="#" type="button" class="inline-block rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-center font-medium text-white hover:bg-indigo-700">Shop Collection</NavLink>
    //       </div>
    //     </div>
    ...
    {windowWidth >= 768 && <Slider {...settings}>
     ...
     <div className="md:container flex justify-between mt-10 xl:px-20 items-center relative md:absolute top-0 left-0 md:left-1/2 translate-x-0 md:-translate-x-1/2 h-full z-20">
       ...
       <div class="sm:max-w-lg">
             <h1 class="font text-3xl font-bold uppercase tracking-tight text-white sm:text-5xl">
               Summer styles are finally here
             </h1>
           ...
           <button class="inline-block rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-center font-medium text-white hover:bg-indigo-700">Shop Collection</button>
           </div>
       </div>
    </div>
 </div>
